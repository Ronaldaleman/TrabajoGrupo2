...
namespace Negocio
{
    ...
    /// <summary>
    /// Esta clase contiene el codigo para el proceso de encriptacion y desencriptacion de las contraseñas
    /// de los usuarios al momento de loguearse en el sistema
    /// </summary>
    public class CCryptorEngine
    {
        ...
        public CCryptorEngine()
        {
            ...
            key = "14efgij2klmn5ñBocdstvwxyzA3CDEFGWpqrHIJK8LQRSTVhMNÑ6790OPXYZab";
        }
