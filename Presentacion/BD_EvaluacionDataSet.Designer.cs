...
namespace Presentacion {
    ...
    public partial class BD_EvaluacionDataSet : global::System.Data.DataSet {
        ...
        public partial class ClientesDataTable : global::System.Data.TypedTableBase<ClientesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ClientesRow AddClientesRow(string Nombre, string Cedula, string Direccion, System.DateTime FechaProceso, int UsuarioProceso, int Estado) {
        ...
        public partial class ClientesRow : global::System.Data.DataRow {
            ...
            public System.DateTime FechaProceso {
                get {
                    return ((global::System.DateTime)(this[this.tableClientes.FechaProcesoColumn]));
                }
                set {
                    this[this.tableClientes.FechaProcesoColumn] = value;
                }
            }
            ...
            public int UsuarioProceso {
                get {
                    return ((int)(this[this.tableClientes.UsuarioProcesoColumn]));
                }
                set {
                    this[this.tableClientes.UsuarioProcesoColumn] = value;
                }
            }
...
namespace Presentacion.BD_EvaluacionDataSetTableAdapters {
    ...
    public partial class ClientesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Clientes] WHERE (([Id] = @Original_Id) AND ([Nombre] = @Original_Nombre) AND ([Cedula] = @Original_Cedula) AND ([Direccion] = @Original_Direccion) AND ([FechaProceso] = @Original_FechaProceso) AND ([UsuarioProceso] = @Original_UsuarioProceso) AND ([Estado] = @Original_Estado))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_UsuarioProceso", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "UsuarioProceso", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Clientes] ([Nombre], [Cedula], [Direccion], [FechaProceso], [UsuarioProceso], [Estado]) VALUES (@Nombre, @Cedula, @Direccion, @FechaProceso, @UsuarioProceso, @Estado);
SELECT Id, Nombre, Cedula, Direccion, FechaProceso, UsuarioProceso, Estado FROM Clientes WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Clientes] SET [Nombre] = @Nombre, [Cedula] = @Cedula, [Direccion] = @Direccion, [FechaProceso] = @FechaProceso, [UsuarioProceso] = @UsuarioProceso, [Estado] = @Estado WHERE (([Id] = @Original_Id) AND ([Nombre] = @Original_Nombre) AND ([Cedula] = @Original_Cedula) AND ([Direccion] = @Original_Direccion) AND ([FechaProceso] = @Original_FechaProceso) AND ([UsuarioProceso] = @Original_UsuarioProceso) AND ([Estado] = @Original_Estado));
SELECT Id, Nombre, Cedula, Direccion, FechaProceso, UsuarioProceso, Estado FROM Clientes WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_UsuarioProceso", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "UsuarioProceso", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Entidad.Properties.Settings.Default.BD_EvaluacionConnectionString;
        }
        ...
        public virtual int Fill(BD_EvaluacionDataSet.ClientesDataTable dataTable) {
        ...
        public virtual BD_EvaluacionDataSet.ClientesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            BD_EvaluacionDataSet.ClientesDataTable dataTable = new BD_EvaluacionDataSet.ClientesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BD_EvaluacionDataSet.ClientesDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Nombre, string Original_Cedula, string Original_Direccion, System.DateTime Original_FechaProceso, int Original_UsuarioProceso, int Original_Estado) {
            ...
            this.Adapter.DeleteCommand.Parameters[5].Value = ((int)(Original_UsuarioProceso));
        ...
        public virtual int Update(string Nombre, string Cedula, string Direccion, System.DateTime FechaProceso, int UsuarioProceso, int Estado, int Original_Id, string Original_Nombre, string Original_Cedula, string Original_Direccion, System.DateTime Original_FechaProceso, int Original_UsuarioProceso, int Original_Estado, int Id) {
            if ((Nombre == null)) {
                throw new global::System.ArgumentNullException("Nombre");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[10].Value = ((System.DateTime)(Original_FechaProceso));
            this.Adapter.UpdateCommand.Parameters[11].Value = ((int)(Original_UsuarioProceso));
        ...
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, string Cedula, string Direccion, System.DateTime FechaProceso, int UsuarioProceso, int Estado, int Original_Id, string Original_Nombre, string Original_Cedula, string Original_Direccion, System.DateTime Original_FechaProceso, int Original_UsuarioProceso, int Original_Estado) {
            return this.Update(Nombre, Cedula, Direccion, FechaProceso, UsuarioProceso, Estado, Original_Id, Original_Nombre, Original_Cedula, Original_Direccion, Original_FechaProceso, Original_UsuarioProceso, Original_Estado, Original_Id);
        }
    }
