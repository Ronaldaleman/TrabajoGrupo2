        ...
        <div class="panel-body">
            <fieldset class="form-group">
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label for="txtDescripcion" class="control-label">Descripción:
                                ...
                                <asp:RequiredFieldValidator ID="rvfDescripcion" runat="server" ErrorMessage="CAMPO ES REQUERIDO" ValidationGroup="insercion" 
                    ...
                    ValidationExpression="^[A-Za-z ]+$" ControlToValidate="txtDescripcion" ValidationGroup="insercion"></asp:RegularExpressionValidator>
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label for="txtExistencia" class="control-label">Existencia:
                                <%--<small style="color:red;font-weight:lighter;font-size:smaller"> campo requerido</small>--%>
                                <asp:RequiredFieldValidator ID="rfvExistencia" runat="server" ErrorMessage="CAMPO ES REQUERIDO" ValidationGroup="insercion"
                    ...
                    ValidationExpression="^[0-9]+$" ControlToValidate="txtExistencia" ValidationGroup="insercion"></asp:RegularExpressionValidator>
                </div>
                <div class="row">
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label for="txtPrecioUnitario" class="control-label">Precio Unitario:
                                <%--<small style="color:red;font-weight:lighter;font-size:smaller"> campo requerido</small>--%>
                                <asp:RequiredFieldValidator ID="rfvPrecioUnitario" runat="server" ErrorMessage="CAMPO ES REQUERIDO" ValidationGroup="insercion"
                    ...
                    ValidationExpression="^\d*\.?\d*" ControlToValidate="txtPrecioUnitario" ValidationGroup="insercion"></asp:RegularExpressionValidator>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="form-group">
                        <asp:Button ID="btnGuardar" runat="server" Text="Guardar" class="btn btn-success" OnClick="btnGuardar_Click" ValidationGroup="insercion"/>
