<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfEditaProductoIndividual.aspx.cs" Inherits="Presentacion.wfEditaProductoIndividual" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <div class="panel panel-default">
        <div class="panel-heading">Edicion de Producto</div>
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label for="txtDescripcion" class="control-label">Descripción:
                                ...
                                <asp:RequiredFieldValidator ID="rfvDescripcion" runat="server" ErrorMessage="CAMPO ES REQUERIDO" 
